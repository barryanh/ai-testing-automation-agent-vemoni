...
function RepoDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => setIsOpen(open)}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Thêm Repository</DialogTitle>
          <DialogDescription>
            Tìm kiếm và chọn một trong các Repository GitHub của bạn
          </DialogDescription>
        </DialogHeader>
        <div>
          <Input
            placeholder="Tìm kiếm repo theo tên..."
        ...
        <DialogFooter className="flex gap-5">
          ...
          <Button onClick={() => SaveRepoToDB()}>Thêm</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
